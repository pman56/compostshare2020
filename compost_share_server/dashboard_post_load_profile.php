...
$(document).ready(function(){
 ...
 var postData ="<?php echo $request_userid; ?>";
        ...
        if(postRow <= postCount){
            ...
            $.ajax({
                url: 'https://qbtut.com/compost_share_server/post_loadmoreData_profile.php',
                type: 'post',
...
if($total_count == 0){
echo "<div style='background:red;color:white;padding:10px;'>No Post  has been Created Yet</div>";
}
...
<b style='color:#0088cc;font-size:18px;' >Name: <?php echo $fullname; ?> </b><br><br>
...
<a title='Click to access users Profile page' style='color:black;' href='https://hackathon20-fesedo.quickbase.com/db/bqyk73arp?a=dbpage&pageID=16&id=<?php echo $userid; ?>'>
...
<button title='View Only this Composts Locations on Map' class="map_css"><a target = "_blank" style="color:white;" href="https://hackathon20-fesedo.quickbase.com/db/bqyk73arp?a=dbpage&pageID=13&identity=<?php echo $timing; ?>">
...
<button title='View All Composts Locations on Map' class="map_css1"><a target = "_blank" style="color:white;" href="https://hackathon20-fesedo.quickbase.com/db/bqyk73arp?a=dbpage&pageID=12">
<i  style="color:white;font-size:30px;" class="fa fa-map-marker" aria-hidden="true"></i>
...
<br><br>
<span><b> <span style='color:#0088cc;' class='fa fa-calendar'></span>Time:</b>  <span data-livestamp="<?php echo $timing;?>"></span></span>
...
&nbsp;<span id="<?php echo $postid; ?>" style="cursor:pointer;" title="Comments" /><a title='Comments' style='color:black' href='https://hackathon20-fesedo.quickbase.com/db/bqyk73arp?a=dbpage&pageID=17&title=<?php echo $title_seo; ?>&pid=<?php echo $postid; ?>&uid=<?php echo $userid; ?>&tit=<?php echo $title; ?>'>Comments</a></span>
...
href='https://hackathon20-fesedo.quickbase.com/db/bqyk73arp?a=dbpage&pageID=17&title=<?php echo $title_seo; ?>&pid=<?php echo $postid; ?>&notifyId='>Click to Read-More & Comments</a></button>
</div>
