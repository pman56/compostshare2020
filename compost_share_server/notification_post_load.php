...
var datasend = {'id': id, 'rid': rid};
		$.ajax({
			...
			type:'POST',
			url:'https://qbtut.com/compost_share_server/notify_delete_post.php',
			data:datasend,
                        crossDomain: true,
			cache:false,
...
<a href='https://hackathon20-fesedo.quickbase.com/db/bqyk73arp?a=dbpage&pageID=16&id=<?php echo $sender_userid; ?>' class='pull-right post-css2' title='View Profile'>Profile</a>
...
<p>
<a href='https://hackathon20-fesedo.quickbase.com/db/bqyk73arp?a=dbpage&pageID=17&title=<?php echo $title1; ?>&notifyId=<?php echo $id; ?>&rID=<?php echo $rid; ?>&pid=<?php echo $post_id; ?>' class='pull-left col-sm-5 post-css' title='View Posts'>View Posts</a>
