...
color:black;
        ...
        <script src="https://qbtut.com/compost_share_server/publish_post2.js" type="text/javascript"></script>
...
//alert('my pid:' +pid);
        ...
        if(postRow <= postCount){
            ...
            $.ajax({
                url: 'https://qbtut.com/compost_share_server/comment_loadmoreData.php',
                type: 'post',
...
<b style='color:#0088cc;font-size:18px;' >Name: <?php echo $fullname2; ?> </b><br><br>
...
<button class='post_css1'>
<a title='Click to access users Profile page' style='color:black;' href='https://hackathon20-fesedo.quickbase.com/db/bqyk73arp?a=dbpage&pageID=16&id=<?php echo $userid2; ?>'>
<span style='font-size:20px;color:#0088cc;' class='fa fa-user'></span> View Users Profile</a></button><br>
...
<br>
<span><b> <span style='color:#0088cc;' class='fa fa-calendar'></span>Time:</b>  <span data-livestamp="<?php echo $timing2;?>"></span></span>
