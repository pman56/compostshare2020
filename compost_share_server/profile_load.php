...
<b style='font-size:20px;color:#0088cc'> This Member has : <?php echo $count_npt; ?> Posts</b><br>


<b style='font-size:16px;'> Member Since:</b> <span data-livestamp='<?php echo $created_time; ?>'></span><br>
<div style='background:#0088cc;color:white;padding:10px;border-radius:20%;font-size:16px;'><i  style='font-size:20px;' class='fa fa-check'></i> User Verified</div>
</div>
